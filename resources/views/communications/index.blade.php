    ...
    <div class="card-header">
        ...
        <div class="card-tools">
            @can('create-communications')
                <a href="{{ route('communications.create') }}" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> New</a>
            @endcan
        </div>
    </div>
    <div class="card-body">
        <table id="dt-communications" class="table table-bordered table-hover">
            <thead>
            <tr>
