...
{{--
  Brand Management List - Products Module
  Module: Products
    ...
    <div class="card">
        <div class="card-header border-0 d-flex justify-content-between align-items-center pt-4 pb-2" style="border-bottom: 1px solid #f0f0f0 !important;">
            <h5 class="font-weight-bold text-dark mb-0" style="font-size:1.1rem;">
                <i class="fas fa-tag mr-2 text-primary"></i>All Brands
            </h5>
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table id="dt-brands" class="table table-hover" style="width:100%">
                    <thead>
...
<style>
    ...
    #dt-brands thead th { white-space: nowrap; }
    #dt-brands tbody tr { transition: background .15s; }
    #dt-brands tbody tr:hover { background: #f0f4ff !important; }
    #dt-brands td { vertical-align: middle; }
</style>
@endpush
