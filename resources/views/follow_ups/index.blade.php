    ...
    <div class="card">
        <div class="card-header border-0 d-flex justify-content-between align-items-center pt-4 pb-2" style="border-bottom: 1px solid #f0f0f0 !important;">
            <h5 class="font-weight-bold text-dark mb-0" style="font-size:1.1rem;">
                <i class="fas fa-calendar-check mr-2 text-primary"></i>All Follow-ups
            </h5>
            <div class="d-flex align-items-center gap-2">
                @can('create-follow_ups')
                    <a href="{{ route('follow_ups.create') }}" class="btn btn-primary btn-sm">
                        <i class="fas fa-plus mr-1"></i> New Follow-up
                    </a>
                @endcan
            </div>
        </div>
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table id="dt-follow_ups" class="table table-hover" style="width:100%">
                    <thead>
...
<style>
    ...
    #dt-follow_ups thead th { white-space: nowrap; }
    #dt-follow_ups tbody tr { transition: background .15s; }
    #dt-follow_ups tbody tr:hover { background: #f0f4ff !important; }
    #dt-follow_ups td { vertical-align: middle; }
</style>
@endpush
