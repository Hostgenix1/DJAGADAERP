...
.qr-inner { border: 1px solid #e2e8f0; padding: 10px; text-align: center; width: 120px; background: #ffffff; }
.qr-inner svg { width: 90px; height: 90px; }
...
.totals-table .balance-row td { color: #991b1b; font-weight: bold; font-size: 10px; }
...
<tr>
    ...
    <td class="header-right">
        ...
        @endphp
        <div style="font-size: 20px; font-weight: bold; color: #1e3a5f; letter-spacing: 1px;">TAX INVOICE</div>
        <div style="font-size: 13px; color: #475569; margin-top: 6px;">{{ $invoice->number }}</div>
...
<tr>
    ...
    <td>{{ $invoice->currency?->code ?? 'AED' }}</td>
</tr>
</table>
...
<tr>
    ...
    <td class="totals-box">
        <table class="totals-table">
            <tr class="sep"><td class="label-col">Subtotal</td><td class="value-col">{{ $invoice->currency?->code == 'AED' ? 'AED' : ($invoice->currency?->symbol ?? 'AED') }} {{ number_format($invoice->subtotal, 2) }}</td></tr>
            @if($invoice->tax_amount > 0)
                <tr class="sep"><td class="label-col">VAT 5%</td><td class="value-col">{{ $invoice->currency?->code == 'AED' ? 'AED' : ($invoice->currency?->symbol ?? 'AED') }} {{ number_format($invoice->tax_amount, 2) }}</td></tr>
            @endif
            @if($invoice->discount > 0)
                <tr class="sep"><td class="label-col">Discount</td><td class="value-col" style="color:#991b1b;">-{{ $invoice->currency?->code == 'AED' ? 'AED' : ($invoice->currency?->symbol ?? 'AED') }} {{ number_format($invoice->discount, 2) }}</td></tr>
            @endif
            <tr class="total-row">
                <td class="label-col" style="color:#ffffff;">TOTAL DUE</td>
                <td class="value-col" style="color:#ffffff;">{{ $invoice->currency?->code == 'AED' ? 'AED' : ($invoice->currency?->symbol ?? 'AED') }} {{ number_format($invoice->total, 2) }}</td>
            </tr>
            @if($invoice->paid_amount > 0)
                <tr class="paid-row">
                    <td class="label-col">PAID</td>
                    <td class="value-col">-{{ $invoice->currency?->code == 'AED' ? 'AED' : ($invoice->currency?->symbol ?? 'AED') }} {{ number_format($invoice->paid_amount, 2) }}</td>
                </tr>
            @endif
            @if($invoice->balance > 0)
                <tr class="balance-row">
                    <td class="label-col">BALANCE DUE</td>
                    <td class="value-col">{{ $invoice->currency?->code == 'AED' ? 'AED' : ($invoice->currency?->symbol ?? 'AED') }} {{ number_format($invoice->balance, 2) }}</td>
                </tr>
...
<div class="payment-strip">
    ...
    <div class="payment-strip-detail">
        @if(!empty($invoice->bankAccount->bank_name))<span>Bank: {{ $invoice->bankAccount->bank_name }}</span>@endif
        @if(!empty($invoice->bankAccount->account_number))<span>Account No: {{ $invoice->bankAccount->account_number }}</span>@endif
        @if(!empty($invoice->bankAccount->iban))<span>IBAN: {{ $invoice->bankAccount->iban }}</span>@endif
        @if(!empty($invoice->bankAccount->swift_code))<span>SWIFT: {{ $invoice->bankAccount->swift_code }}</span>@endif
    </div>
</div>
@endif
...
<div class="footer-line">
 ...
 }} {{ number_format($invoice->subtotal, 2) }}</td></tr>
            @if($invoice->tax_amount > 0)
                <tr class="sep"><td class="label-col">VAT 5%</td><td class="value-col">{{ $invoice->currency?->symbol ?? ' }} {{ number_format($invoice->tax_amount, 2) }}</td></tr>
            @endif
            @if($invoice->discount > 0)
                <tr class="sep"><td class="label-col">Discount</td><td class="value-col" style="color:#991b1b;">-{{ $invoice->currency?->code == 'AED' ? 'AED' : ($invoice->currency?->symbol ?? 'AED') }} {{ number_format($invoice->discount, 2) }}</td></tr>
            @endif
...
<div class="footer-line">
 ...
 }} {{ number_format($invoice->tax_amount, 2) }}</td></tr>
            @endif
            @if($invoice->discount > 0)
...
<div class="footer-line">
 ...
 }} {{ number_format($invoice->discount, 2) }}</td></tr>
            @endif
            <tr class="total-row">
                <td class="label-col" style="color:#ffffff;">TOTAL DUE</td>
