    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card"><div class="card-body">
                <button type="submit" class="btn btn-primary btn-block"><i class="fas fa-save"></i> Save Invoice</button>
                <a href="{{ route('invoices.index') }}" class="btn btn-default btn-block">Cancel</a>
            </div></div>
        </div>
    </div>
</form>
