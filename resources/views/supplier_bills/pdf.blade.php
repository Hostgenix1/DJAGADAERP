...
<table class="meta-table">
    <tr>
        ...
        <td class="meta-box" style="width:34%;">
            ...
            <div class="meta-row value" style="font-weight:bold; font-size:9.6pt;">{{ $bill->supplier?->company_name }}</div>
            ...
            @if($bill->supplier?->tax_registration_number)<div class="meta-row value">VAT/TRN: {{ $bill->supplier->tax_registration_number }}</div>@endif
        </td>
