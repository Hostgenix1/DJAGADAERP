    ...
    <div class="card">
        <div class="card-header border-0 d-flex justify-content-between align-items-center pt-4 pb-2" style="border-bottom: 1px solid #f0f0f0 !important;">
            <h5 class="font-weight-bold text-dark mb-0" style="font-size:1.1rem;">
                <i class="fas fa-boxes mr-2 text-primary"></i>All Products
            </h5>
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table id="dt-products" class="table table-hover" style="width:100%">
                    <thead>
...
<style>
    ...
    #dt-products thead th { white-space: nowrap; }
    #dt-products tbody tr { transition: background .15s; }
    #dt-products tbody tr:hover { background: #f0f4ff !important; }
    #dt-products td { vertical-align: middle; }
</style>
@endpush
